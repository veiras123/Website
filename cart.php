...
<body>
  <nav class="navbar navbar-expand-md bg-dark navbar-dark">
    ...
    <div class="collapse navbar-collapse" id="collapsibleNavbar">
      <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item">
          <a class="nav-link" href="register.html"><i class="fas fa-th-list mr-2"></i>Register</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="login.html"><i class="fas fa-th-list mr-2"></i>Login</a>
        </li>
        <li class="nav-item">
  ...
  echo $_SESSION['message'];
      ...
      <input type="hidden" id="finalAmount" value="<?php echo $grand_total ?>">
    </div>
